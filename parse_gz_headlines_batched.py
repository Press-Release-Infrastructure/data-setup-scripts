...
with open('/home/ec2-user/data_setup_scripts/curr_gz_batch.txt', 'r') as batch:
    gz_files = batch.read().splitlines()
    count = 0
    for file_path in gz_files:
        ...
        if count % 100 == 0:
            ...
            print('Num: {} Python Time (Batch): {} SQL Time (Batch): {} File Size (Current): {}'.format(file_num + count, python_time, sql_time, file_size))
            python_time = 0
            sql_time = 0
